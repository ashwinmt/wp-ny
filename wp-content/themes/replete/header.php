				...
				<div class='container_wrap container_wrap_logo header_color <?php avia_is_dark_bg('header_color'); ?>'>
						...
						<div class='container' id='logo_container'>
							...
							*/
							...
							// wp_nav_menu($args);
							// echo "</div>";
							$image_attributes = wp_get_attachment_image_src(202, 'full', false);
							if( $image_attributes ) {
							?>
							<div style="padding: 15px 0 8px 0;float: left; display: block;"> 
								<img src="<?php echo $image_attributes[0]; ?>" width="100%" height="100%">
							</div>
							<?php } ?>
